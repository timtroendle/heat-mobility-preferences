...
![**Attribute level correlations of our experimental designs.** Colour of rectangles shows the number of times two attribute levels occurred together within one profile. The experiments contain n=17,800 policy packages.](build/paper/choice-experimental-design.png){#fig:experimental-design tag="S5"}
