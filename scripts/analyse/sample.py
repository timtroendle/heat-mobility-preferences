    ...
    table = pd.DataFrame(
        ...
        data={
            "sample": [
                ...
                sample[sample["residential_area"] == "<2'000 inh."].ID.count() / total_sample,
                sample[sample["residential_area"] == "2'000 - 5'000 inh."].ID.count() / total_sample,
                sample[sample["residential_area"] == "5'000 - 20'000 inh."].ID.count() / total_sample,
                sample[sample["residential_area"] == "20'000 - 50'000 inh."].ID.count() / total_sample,
                sample[sample["residential_area"] == "50'000 - 100'000 inh."].ID.count() / total_sample,
                sample[sample["residential_area"] == "100'000 - 500'000 inh."].ID.count() / total_sample,
                sample[sample["residential_area"] == " > 500'000 inh."].ID.count() / total_sample,
            ],
            "population": [
